...
def main():
    ...
    totalT = 3000
    n_spatF = 7
    spat_speed = np.linspace(2,5,n_spatF)#2  # spatial Frequency in Hz ->speed (!)
    ...
    np.save('./work/directGrating_Sinus_SpikeCount_LGN',rec_LGN, allow_pickle=False)
    np.save('./work/directGrating_Sinus_SpikeCount_E1',rec_E1, allow_pickle=False)
    np.save('./work/directGrating_Sinus_SpikeCount_I1',rec_IL1, allow_pickle=False)
