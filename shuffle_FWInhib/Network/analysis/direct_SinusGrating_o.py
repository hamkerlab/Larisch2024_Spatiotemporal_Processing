...
def calcDSI(data, totalT, name,c_lvl):
    print(data[:,0,0])
    ...
    plt.xlim(0,1)
    plt.savefig('./Output/direct_gratingSinus/LVL_%i/dsi_maz_hist_'%(c_lvl)+(name))
    plt.close()
    ...
    plt.xlim(0,1)
    plt.savefig('./Output/direct_gratingSinus/LVL_%i/dsi_will_hist_'%(c_lvl)+(name))
    plt.close()
    ...
    plt.xlim(0,1)
    plt.savefig('./Output/direct_gratingSinus/LVL_%i/dsi_kim_hist_'%(c_lvl)+(name))
    plt.close()

def evalDSI(totalT,cont_LVL):
    ...
    spkC_I1 = spkC_I1[cont_LVL]
    #spkC_I2 = spkC_I2[cont_LVL]

    #calcDSI(spkC_E2,totalT,'E2',cont_LVL)
    print(totalT)
    calcDSI(spkC_I1,totalT,'I1',cont_LVL)
...
def main():
    ...
    n_contrast = np.shape(spkC_E1_all)[0]
    ...
    for i in range(n_contrast):
        ...
        plt.legend()
        plt.savefig('./Output/direct_gratingSinus/LVL_%i/gEx_gInh_preff_E1_hist.png'%(i))
        plt.close()
        ...
        plt.legend()
        plt.savefig('./Output/direct_gratingSinus/LVL_%i/gEx_gInh_null_E1_hist.png'%(i))
        plt.close()
        ...
        plt.legend()
        plt.savefig('./Output/direct_gratingSinus/LVL_%i/gEx_gInh_pref_I1_hist.png'%(i))

        plt.figure()
        plt.hist(np.mean(null_gE_I1,axis=1),24,label='gExc', alpha = 0.5)
        plt.hist(np.mean(null_gI_I1,axis=1),24,label='gInh', alpha = 0.5)
        plt.legend()
        plt.savefig('./Output/direct_gratingSinus/LVL_%i/gEx_gInh_null_I1_hist.png'%(i))
        ...
        plt.legend()
        plt.savefig('./Output/direct_gratingSinus/LVL_%i/E1/preff_null_VM_100_resh.png'%(i))

        plt.figure()
        plt.plot(preff_vm[100,0:250],color='steelblue',label='pref')
        plt.plot(null_vm[100,0:250],color='tomato',label='null')
        plt.legend()
        plt.savefig('./Output/direct_gratingSinus/LVL_%i/E1/preff_null_VM_100.png'%(i))
        ...
        plt.axvline(np.mean(dsi_maz),color='black',linestyle='--',linewidth=4)
        plt.xlim(0,1)
        plt.savefig('./Output/direct_gratingSinus/LVL_%i/dsi_maz_hist_E1'%(i))
        plt.close()
        ...
        plt.axvline(np.mean(dsi_will),color='black',linestyle='--',linewidth=4)
        plt.xlim(0,1)
        plt.savefig('./Output/direct_gratingSinus/LVL_%i/dsi_will_hist_E1'%(i))
        plt.close()
        ...
        plt.axvline(np.mean(dsi_kim),color='black',linestyle='--',linewidth=4)
        plt.xlim(0,1)
        plt.savefig('./Output/direct_gratingSinus/LVL_%i/dsi_kim_hist_E1'%(i))
        plt.close()
        ...
        for c in range(n_cellsE1):
            ...
            ax.legend() 
            plt.savefig('./Output/direct_gratingSinus/LVL_%i/E1/direct_Polar_%i'%(i,c))
            plt.close()
        ...
        for c in range(n_cellsI1):
            ...
            ax.legend() 
            plt.savefig('./Output/direct_gratingSinus/LVL_%i/I1/direct_Polar_%i'%(i,c))
            plt.close()
#------------------------------------------------------------------------------
