...
def startAnalyze():
    ...
    for x in overX:
        ...
        plt.figure()
        plt.imshow(np.mean(data_c,axis=2), cmap=plt.get_cmap('gray',7), aspect='auto')
    ...
    for y in overY:
        ...
        plt.figure()
        plt.imshow(np.mean(data_c,axis=1), cmap=plt.get_cmap('gray',7), aspect='auto')
