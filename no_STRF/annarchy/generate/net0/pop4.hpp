...
///////////////////////////////////////////////////////////////
// Main Structure for the population of id 4 (pop4)
///////////////////////////////////////////////////////////////
struct PopStruct4{
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "PopStruct4::get_global_attribute_double: " << name << " not found" << std::endl;
        return static_cast<double>(0.0);
    }
    ...
    void set_global_attribute_double(std::string name, double value)  {
        ...
        std::cerr << "PopStruct4::set_global_attribute_double: " << name << " not found" << std::endl;
    }
    ...
    std::cout << "PopStruct4::clear() - this = " << this << std::endl;
            ...
            #ifdef _DEBUG
                std::cout << "PopStruct4::clear()" << std::endl;
            #endif
        // Parameters
