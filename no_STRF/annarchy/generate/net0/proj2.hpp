...
/////////////////////////////////////////////////////////////////////////////
// proj2: pop1 -> pop3 with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct2 : LILMatrix<int, int> {
    ProjStruct2() : LILMatrix<int, int>( 968, 484) {
    }
    ...
    void compute_psp() {
        ...
        if (pop3._active) {
            for (int i=0; i<post_rank.size(); i++) {
                pop3.g_exc[post_rank[i]] += pop1.r[pre_rank[i][0]];
            }
        } // active
    ...
    double get_global_attribute_double(std::string name) {
        ...
        // should not happen
        std::cerr << "ProjStruct2::get_global_attribute_double: " << name << " not found" << std::endl;
        return 0.0;
    }
